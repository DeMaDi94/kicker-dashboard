...
| `STAT-01` | done | `tests/Feature/Statistics/StatisticsPagesTest.php`<br>`tests/e2e/league.spec.ts` | Jeder Mitspieler hat eine eigene Seite, ohne Anmeldung lesbar; sein Name in Gesamttabelle… |
